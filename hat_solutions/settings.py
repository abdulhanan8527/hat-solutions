"""
Django settings for hat_solutions project.
...
SECRET_KEY = 'django-insecure-!x%m7qhtds&9e^kxl7u-foy15^c^0ipfyck@gpv%$1e6=!%q_j'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['.vercel.app', 'www.thehatsolution.com', 'thehatsolution.com', '127.0.0.1']
...
ROOT_URLCONF = 'hat_solutions.urls'
...
WSGI_APPLICATION = 'hat_solutions.wsgi.application'
